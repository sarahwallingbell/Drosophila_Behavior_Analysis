function joint_derivative_x_phase_plot_rot_vel_binned_walk_x_speed(data, steps, flies, param, joint, phase, derivative, tossSmallBins, minNumSteps, velocityBins, fig_name, varargin)
