function joint_x_phase_plot_fwd_vel_binned_walk_x_speed_normed(data, steps, flies, param, joint, phase, tossSmallBins, minNumSteps, velocityBins, fig_name, varargin)

% plot average joint x speed for ctl vs stim binned by forward velocity. 
% normalized by the joint angle for the average step (across all speeds). 
% This shows 'deviation from the average step'. 
%
% Optional params:
