function joint_x_phase_plot_fwd_vel_binned_exp_minus_ctl(data, steps, flies, param, joint, phase, tossSmallBins, minNumSteps, velocityBins, laserColor, fig_name, varargin)
