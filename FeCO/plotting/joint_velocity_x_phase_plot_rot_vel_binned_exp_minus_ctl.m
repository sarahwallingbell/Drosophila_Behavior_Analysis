function joint_velocity_x_phase_plot_rot_vel_binned_exp_minus_ctl(data, steps, flies, param, joint, phase, tossSmallBins, minNumSteps, velocityBins, laserColor, fig_name, varargin)
